Приложение содержит внутри себя пайплайн предобработки данных (строка json) и прогнозирования вероятности целевого действия. Модель прогнозирования Catboost. Api (fastapi). Все упаковано в докер-контейнер.

Подробное описание курсового проекта можно прочесть в презентации, которую можно найти в данном репозитории. 
Там есть полное описание процесса исследования данных, фичеинжиниринга, моделирования при помощи различных алгоритмов, оценки их качества, выбора модели, подбора порога прогнозирования, и структуру сервиса.
